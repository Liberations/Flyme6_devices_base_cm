...
.method private readRules(Ljava/io/File;[Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;)V
    ...
    :try_start_4
    const-string v16, "IntentFirewall"

    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string v18, "Error reading intent firewall rules from "
    ...
    const-string v18, "Error reading an intent firewall rule from "
    ...
    const-string v18, "Error while closing "
    ...
    .restart local v3    # "ex":Ljava/io/IOException;
    const-string v17, "IntentFirewall"

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string v19, "Error while closing "
