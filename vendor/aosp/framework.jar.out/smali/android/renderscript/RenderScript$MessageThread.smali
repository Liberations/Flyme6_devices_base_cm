...
.method public run()V
    ...
    const-string v9, "Received a message from the script with no message handler installed."
    ...
    :cond_6
    const-string v8, "RenderScript_jni"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "non fatal RS error, "
