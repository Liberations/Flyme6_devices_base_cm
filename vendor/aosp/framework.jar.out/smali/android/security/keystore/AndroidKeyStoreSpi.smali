...
.method private setSecretKeyEntry(Ljava/lang/String;Ljavax/crypto/SecretKey;Ljava/security/KeyStore$ProtectionParameter;)V
    ...
    const-string v4, "KeyStore-backed secret key does not have an alias"
    ...
    const-string v6, "KeyStore-backed secret key has invalid alias: "
    ...
    const-string v6, "Can only replace KeyStore-backed keys with same alias: "
    ...
    const-string v4, "Modifying KeyStore-backed key using protection parameters not supported"
    ...
    const-string v4, "Protection parameters must be specified when importing a symmetric key"
    ...
    const-string v4, "Only secret keys that export their key material are supported"
    ...
    const-string v6, "Unsupported secret key material export format: "
    ...
    const-string v4, "Key did not export its key material despite supporting RAW format export"
    ...
    const-string v6, "HMAC key algorithm digest unknown for key algorithm "
    ...
    const-string v6, "Unsupported digests specification: "
    ...
    const-string v6, " supported for HMAC key algorithm "
    ...
    const-string v6, "Randomized encryption (IND-CPA) required but may be violated by block mode: "
    ...
    const-string v6, ". See KeyProtection documentation."
    ...
    const-string v4, "Signature paddings not supported for symmetric keys"
    ...
    const-string v6, "Failed to import secret key. Keystore error code: "
