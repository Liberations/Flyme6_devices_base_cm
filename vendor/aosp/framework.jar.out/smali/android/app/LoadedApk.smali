...
.method private rewriteRValues(Ljava/lang/ClassLoader;Ljava/lang/String;I)V
    ...
    :try_start_1
    const-string v7, "onResourcesLoaded"
    ...
    const-string v9, "No resource references to update in package "
    ...
    const-string v9, "Failed to rewrite resource references for "
...
.method public removeContextRegistrations(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v11, " has leaked IntentReceiver "
    ...
    const-string v11, " that was "

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string v11, "originally registered here. Are you missing a "

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string v11, "call to unregisterReceiver()?"
    ...
    const-string v11, " has leaked ServiceConnection "
    ...
    const-string v11, " that was originally bound here"
