...
.method public constructor <init>(Landroid/content/pm/PackageManager;)V
    ...
    const-string v18, "com.android.intent.action.MANAGE_VOICE_KEYPHRASES"
    ...
    :cond_0
    const-string v17, "No enrollment application found"
    ...
    const-string v17, "KeyphraseEnrollmentInfo"
    ...
    const-string v19, "is not a privileged system app"
    ...
    const-string v18, "error parsing voice enrollment meta-data"
    ...
    :cond_2
    :try_start_1
    const-string v17, "android.permission.MANAGE_VOICE_KEYPHRASES"
    ...
    const-string v19, " does not require MANAGE_VOICE_KEYPHRASES"
    ...
    const-string v17, "No suitable enrollment application found"
    ...
    :try_start_2
    const-string v17, "android.voice_enrollment"
    ...
    const-string v18, "No android.voice_enrollment meta-data for "
    ...
    const-string v17, "voice-enrollment-application"
    ...
    const-string v17, "Meta-data does not start with voice-enrollment-application tag"
    ...
    const-string v18, "Error parsing keyphrase enrollment meta-data: "
...
.method public getKeyphraseMetadata(Ljava/lang/String;Ljava/util/Locale;)Landroid/hardware/soundtrigger/KeyphraseMetadata;
    ...
    const-string v2, "Enrollment application doesn\'t support keyphrases"
    ...
    const-string v2, "Enrollment application doesn\'t support the given keyphrase/locale"
