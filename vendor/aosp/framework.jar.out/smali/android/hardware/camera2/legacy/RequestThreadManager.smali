...
.field private static final REQUEST_COMPLETE_TIMEOUT:I = 0x64
...
.method private declared-synchronized configureOutputs(Ljava/util/Collection;)V
    .locals 40
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/camera2/legacy/GLThreadManager;->waitUntilStarted()V
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/camera2/legacy/GLThreadManager;->ignoreNewFrames()V
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/camera2/legacy/GLThreadManager;->waitUntilIdle()V
    ...
    .line 375
    .local v26, "previewOutputSizes":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    ...
    sget-object v36, Landroid/hardware/camera2/CameraCharacteristics;->LENS_FACING:Landroid/hardware/camera2/CameraCharacteristics$Key;

    invoke-virtual/range {v35 .. v36}, Landroid/hardware/camera2/CameraCharacteristics;->get(Landroid/hardware/camera2/CameraCharacteristics$Key;)Ljava/lang/Object;
    ...
    sget-object v36, Landroid/hardware/camera2/CameraCharacteristics;->SENSOR_ORIENTATION:Landroid/hardware/camera2/CameraCharacteristics$Key;
    ...
    .local v22, "outPair$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    .line 382
    .local v30, "s":Landroid/view/Surface;
    move-object/from16 v0, v21
    ...
    .line 384
    .local v23, "outSize":Landroid/util/Size;
    :try_start_2
    invoke-static/range {v30 .. v30}, Landroid/hardware/camera2/legacy/LegacyCameraDevice;->detectSurfaceType(Landroid/view/Surface;)I
    ...
    invoke-static {v0, v14, v1}, Landroid/hardware/camera2/legacy/LegacyCameraDevice;->setSurfaceOrientation(Landroid/view/Surface;II)V
    ...
    const-string/jumbo v36, "Surface abandoned, skipping..."
    ...
    .end local v22    # "outPair$iterator":Ljava/util/Iterator;
    .end local v23    # "outSize":Landroid/util/Size;
    .end local v26    # "previewOutputSizes":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    .end local v30    # "s":Landroid/view/Surface;
    :catchall_0
    move-exception v35
    ...
    const-string/jumbo v36, "Received device exception in configure call: "
    ...
    .line 342
    invoke-virtual/range {v35 .. v36}, Landroid/hardware/camera2/legacy/CameraDeviceState;->setError(I)V
    :try_end_4
    ...
    .restart local v22    # "outPair$iterator":Ljava/util/Iterator;
    .restart local v23    # "outSize":Landroid/util/Size;
    .restart local v26    # "previewOutputSizes":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    .restart local v30    # "s":Landroid/view/Surface;
    :pswitch_0
    const/16 v35, 0x1
    ...
    invoke-static/range {v30 .. v30}, Landroid/hardware/camera2/legacy/LegacyCameraDevice;->getSurfaceId(Landroid/view/Surface;)J
    ...
    :try_end_5
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_5 .. :try_end_5} :catch_0
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/Camera;->getParameters()Landroid/hardware/Camera$Parameters;
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/Camera$Parameters;->getSupportedPreviewFpsRange()Ljava/util/List;

    move-result-object v33

    .line 419
    .local v33, "supportedFpsRanges":Ljava/util/List;, "Ljava/util/List<[I>;"
    move-object/from16 v0, p0
    ...
    .line 425
    invoke-virtual/range {v35 .. v37}, Landroid/hardware/Camera$Parameters;->setPreviewFpsRange(II)V
    ...
    .line 431
    .local v32, "smallestSupportedJpegSize":Landroid/util/Size;
    ...
    .line 433
    invoke-static/range {v26 .. v26}, Landroid/hardware/camera2/utils/SizeAreaComparator;->findLargestByArea(Ljava/util/List;)Landroid/util/Size;
    ...
    invoke-static/range {v35 .. v35}, Landroid/hardware/camera2/legacy/ParameterUtils;->getLargestSupportedJpegSizeByArea(Landroid/hardware/Camera$Parameters;)Landroid/util/Size;
    ...
    .line 441
    invoke-static/range {v35 .. v35}, Landroid/hardware/camera2/legacy/ParameterUtils;->convertSizeList(Ljava/util/List;)Ljava/util/List;

    move-result-object v34

    .line 447
    .local v34, "supportedPreviewSizes":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    ...
    invoke-static/range {v34 .. v34}, Landroid/hardware/camera2/utils/SizeAreaComparator;->findLargestByArea(Ljava/util/List;)Landroid/util/Size;
    ...
    .local v31, "s$iterator":Ljava/util/Iterator;
    :cond_2
    :goto_2
    ...
    check-cast v29, Landroid/util/Size;

    .line 450
    .local v29, "s":Landroid/util/Size;
    ...
    .end local v29    # "s":Landroid/util/Size;
    .end local v31    # "s$iterator":Ljava/util/Iterator;
    .end local v32    # "smallestSupportedJpegSize":Landroid/util/Size;
    .end local v33    # "supportedFpsRanges":Ljava/util/List;, "Ljava/util/List<[I>;"
    .end local v34    # "supportedPreviewSizes":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    :catch_2
    move-exception v13
    ...
    const-string/jumbo v36, "Received device exception: "
    ...
    .restart local v32    # "smallestSupportedJpegSize":Landroid/util/Size;
    .restart local v33    # "supportedFpsRanges":Ljava/util/List;, "Ljava/util/List<[I>;"
    :cond_3
    ...
    .restart local v31    # "s$iterator":Ljava/util/Iterator;
    .restart local v34    # "supportedPreviewSizes":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    :cond_4
    :try_start_8
    move-object/from16 v0, p0
    ...
    const-string/jumbo v37, "configureOutputs - set take picture size to "
    ...
    invoke-static {v0, v14, v1}, Landroid/hardware/camera2/legacy/LegacyCameraDevice;->setSurfaceOrientation(Landroid/view/Surface;II)V
    :try_end_9
    .catch Landroid/hardware/camera2/legacy/LegacyExceptionUtils$BufferQueueAbandonedException; {:try_start_9 .. :try_end_9} :catch_3
    ...
    .line 500
    new-instance v35, Landroid/hardware/camera2/legacy/GLThreadManager;
    ...
    invoke-direct {v0, v1, v14, v2}, Landroid/hardware/camera2/legacy/GLThreadManager;-><init>(IILandroid/hardware/camera2/legacy/CameraDeviceState;)V
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/camera2/legacy/GLThreadManager;->start()V
    ...
    .line 505
    .local v28, "previews":Ljava/util/List;, "Ljava/util/List<Landroid/util/Pair<Landroid/view/Surface;Landroid/util/Size;>;>;"
    invoke-interface/range {v26 .. v26}, Ljava/util/List;->iterator()Ljava/util/Iterator;

    move-result-object v27

    .line 506
    .local v27, "previewSizeIter":Ljava/util/Iterator;, "Ljava/util/Iterator<Landroid/util/Size;>;"
    move-object/from16 v0, p0
    ...
    .local v25, "p$iterator":Ljava/util/Iterator;
    :goto_5
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/camera2/legacy/GLThreadManager;->allowNewFrames()V
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/hardware/camera2/legacy/GLThreadManager;->getCurrentSurfaceTexture()Landroid/graphics/SurfaceTexture;
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/graphics/SurfaceTexture;->setOnFrameAvailableListener(Landroid/graphics/SurfaceTexture$OnFrameAvailableListener;)V
    :try_end_a
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/hardware/Camera;->setParameters(Landroid/hardware/Camera$Parameters;)V
    :try_end_b
    ...
    const-string/jumbo v36, "Received device exception while configuring: "
