...
.method private checkVersionAndBuildLocked()V
    ...
    const-string v12, "Upgrading from version "
    ...
    const-string v10, "Failed to write new version"
...
.method private doUpgradeLocked(I)V
    ...
    const-string v4, "Deleting all usage stats files"
...
.method public checkinDailyFiles(Lcom/android/server/usage/UsageStatsDatabase$CheckinAction;)Z
    ...
    const-string v12, "Failed to mark file "
    ...
    const-string v12, " as checked-in"
...
.method public onTimeChanged(J)V
    ...
    const-string v14, "Time changed by "
    ...
    .end local v8    # "i":I
    :cond_3
    const-string v14, " files deleted: "
    ...
    const-string v14, "UsageStatsDatabase"
