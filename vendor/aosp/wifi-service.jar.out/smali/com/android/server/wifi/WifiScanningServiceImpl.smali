...
.method addScanRequest(Lcom/android/server/wifi/WifiScanningServiceImpl$ClientInfo;ILandroid/net/wifi/WifiScanner$ScanSettings;)Z
    ...
    const-string v2, "Failing scan request because periodInMs is "
    ...
    const-string v2, "Failing scan request because minSupportedPeriodMs is "
    ...
    const-string v2, " but the request wants "
    ...
    :cond_6
    const-string v1, "addScanRequest"
...
.method addSingleScanRequest(Lcom/android/server/wifi/WifiScanningServiceImpl$ClientInfo;ILandroid/net/wifi/WifiScanner$ScanSettings;)Z
    ...
    :cond_2
    const-string v0, "addSingleScanRequest"
    ...
    const-string v0, "Failing scan request because failed to reset scan"
...
.method reportScanResults()Z
    ...
    const-string v4, "No SCAN results received"
