...
.method private readOldState(Landroid/os/ParcelFileDescriptor;)Landroid/util/ArrayMap;
    ...
    :cond_0
    const-string v12, "BlobBackupHelper"

    new-instance v13, Ljava/lang/StringBuilder;

    invoke-direct {v13}, Ljava/lang/StringBuilder;-><init>()V

    const-string v14, "Prior state from unrecognized version "
    ...
    const-string v14, "Error examining prior backup state "
...
.method public performBackup(Landroid/os/ParcelFileDescriptor;Landroid/app/backup/BackupDataOutput;Landroid/os/ParcelFileDescriptor;)V
    ...
    .local v4, "e":Ljava/lang/Exception;
    :try_start_1
    const-string v10, "BlobBackupHelper"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Unable to record notification state: "
