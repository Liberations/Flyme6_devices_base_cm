...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :sswitch_0
    const-string v9, "android.bluetooth.IBluetoothHidDeviceCallback"
    ...
    check-cast v4, Landroid/bluetooth/BluetoothHidDeviceAppConfiguration;
    ...
    .local v7, "_arg2":Z
    :goto_2
    invoke-virtual {p0, v1, v4, v7}, Landroid/bluetooth/IBluetoothHidDeviceCallback$Stub;->onAppStatusChanged(Landroid/bluetooth/BluetoothDevice;Landroid/bluetooth/BluetoothHidDeviceAppConfiguration;Z)V
    ...
    .local v4, "_arg1":Landroid/bluetooth/BluetoothHidDeviceAppConfiguration;
    goto :goto_1

    .end local v4    # "_arg1":Landroid/bluetooth/BluetoothHidDeviceAppConfiguration;
    :cond_2
    const/4 v7, 0x0
    ...
    .local v6, "_arg2":I
    invoke-virtual {p0, v0, v2, v6}, Landroid/bluetooth/IBluetoothHidDeviceCallback$Stub;->onGetReport(BBI)V
    ...
    .local v8, "_arg2":[B
    invoke-virtual {p0, v0, v2, v8}, Landroid/bluetooth/IBluetoothHidDeviceCallback$Stub;->onSetReport(BB[B)V
    ...
    .local v5, "_arg1":[B
    invoke-virtual {p0, v0, v5}, Landroid/bluetooth/IBluetoothHidDeviceCallback$Stub;->onIntrData(B[B)V
