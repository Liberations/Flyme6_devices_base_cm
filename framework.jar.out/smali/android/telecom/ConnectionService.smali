...
.field private static final MSG_EXPLICIT_TRANSFER:I = 0x17
...
.method static synthetic -wrap17(Landroid/telecom/ConnectionService;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p1, "callId"    # Ljava/lang/String;
...
.method static synthetic -wrap18(Landroid/telecom/ConnectionService;Landroid/telecom/Conference;)V
    .locals 0
...
.method static synthetic -wrap24(Landroid/telecom/ConnectionService;Ljava/lang/String;)V
    ...
    .prologue
    invoke-direct {p0, p1}, Landroid/telecom/ConnectionService;->transfer(Ljava/lang/String;)V
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    .prologue
    const-string v5, "createConnection, callManagerAccount: %s, callId: %s, request: %s, isIncoming: %b, isUnknown: %b"
    ...
    :goto_1
    const-string v5, "createConnection, number: %s, state: %s, capabilities: %s, properties: %s"
...
.method private reject(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    const-string v0, "reject %s with message"
...
.method private transfer(Ljava/lang/String;)V
    .locals 3
    .param p1, "callId"    # Ljava/lang/String;

    .prologue
    const-string v0, "transfer %s"
    ...
    invoke-virtual {v0}, Landroid/telecom/Connection;->onTransfer()V
