...
.method private settingsActivityFromServiceInfo(Landroid/content/pm/ServiceInfo;Landroid/content/pm/PackageManager;)Ljava/lang/String;
    ...
    :try_start_0
    const-string v9, "android.speech.tts"
    ...
    const-string v11, "No meta-data found for :"
    ...
    const-string v11, " uses unknown tag :"
    ...
    const-string v11, "Error parsing metadata for "
    ...
    const-string v11, "Could not load resources for : "
...
.method public parseLocaleString(Ljava/lang/String;)Ljava/util/Locale;
    ...
    const-string v10, " to a valid Locale object. Only"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string v10, " separators"
    ...
    const-string v10, " to a valid Locale object. Too"

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string v10, " many separators"
